...
void ColorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->colorChanging((*reinterpret_cast<std::add_pointer_t<QColor>>(_a[1]))); break;
        case 5: _t->button_cb(); break;
        case 6: _t->rejected_cb(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ColorButton::*)()>(_a, &ColorButton::colorChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ColorButton::*)()>(_a, &ColorButton::rejected, 1))
            return;
    }
}
...
void *ColorButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::UI_ColorButton"))
        return static_cast< Ui::UI_ColorButton*>(this);
