...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->startSearchCB(); break;
        case 1: _t->previousSearchCB(); break;
        case 2: _t->nextSearchCB(); break;
        case 3: _t->quitSearchCB(); break;
...
void *FindDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::UI_FindDialog"))
        return static_cast< Ui::UI_FindDialog*>(this);
