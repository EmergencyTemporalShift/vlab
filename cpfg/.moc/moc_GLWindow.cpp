...
template <> constexpr inline auto GLWindow::qt_create_metaobjectdata<qt_meta_tag_ZN8GLWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'closeEvent'
        QtMocHelpers::SlotData<void(QCloseEvent *)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 10, 2 },
        }}),
        // Slot 'savePS'
...
void GLWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->resizeDone(); break;
        case 1: _t->about_cpfg_cb(); break;
        case 2: _t->onlineHelp(); break;
        case 3: _t->pdfHelp(); break;
        case 4: _t->quickHelp(); break;
        case 5: _t->enviropdfHelp(); break;
        case 6: _t->graphpdfHelp(); break;
        case 7: _t->closeEvent((*reinterpret_cast<std::add_pointer_t<QCloseEvent*>>(_a[1]))); break;
        case 8: _t->savePS(); break;
        default: ;
        }
    }
}
