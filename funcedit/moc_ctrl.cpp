...
template <> constexpr inline auto Ctrl::qt_create_metaobjectdata<qt_meta_tag_ZN4CtrlE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'msgBoxClosed'
        QtMocHelpers::SlotData<void(QAbstractButton *)>(18, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 19, 2 },
        }}),
...
void Ctrl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->FuncName(); break;
        case 1: _t->SetSamples(); break;
        case 2: _t->Reload(); break;
        case 3: _t->Save(); break;
        case 4: _t->SaveAs(); break;
        case 5: _t->LoadBackGrdImage(); break;
        case 6: _t->SaveInContinuousMode(); break;
        case 7: _t->FlipView((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
