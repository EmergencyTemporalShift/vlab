...
ColourPick::ColourPick(QWidget *parent, const char*, QOpenGLWidget *globj,
                       bool fixsize, Qt::WindowFlags f)
    : QWidget(parent, f) {

  setWindowTitle("Colour Pick : " + parentWidget()->windowTitle());
  slidermode = "no";
  ...
  QLabel *hL1 = new QLabel("H", this);
  QLabel *hL2 = new QLabel("H", this);
  hSl = new QSlider(Qt::Horizontal, this);
  hSl->setObjectName("hSl");
  hSl->setMinimum(UNDEFINED);
  hSl->setMaximum(36000);
  hSl->setPageStep(4500);
  hSl->setValue(0);

  hSl->setTickPosition(QSlider::TicksAbove);

  hLe = new QLineEdit("UNDEF", this);
  ...
  QLabel *sL1 = new QLabel("S", this);
  QLabel *sL2 = new QLabel("S", this);
  sSl = new QSlider(Qt::Horizontal, this);
  sSl->setObjectName("sSl");
  sSl->setMinimum(0);
  sSl->setMaximum(1000);
  sSl->setPageStep(125);
  sSl->setValue(0);
  sSl->setTickPosition(QSlider::TicksAbove);

  sLe = new QLineEdit("0.000", this);
  ...
  QLabel *vL1 = new QLabel("V", this);
  QLabel *vL2 = new QLabel("V", this);
  vSl = new QSlider(Qt::Horizontal, this);
  vSl->setObjectName("vSl");
  vSl->setMinimum(0);
  vSl->setMaximum(1000);
  vSl->setPageStep(125);
  vSl->setValue(0);
  vSl->setTickPosition(QSlider::TicksAbove);

  vLe = new QLineEdit("0.000", this);
  ...
  QLabel *rL1 = new QLabel("R", this);
  QLabel *rL2 = new QLabel("R", this);
  rSl = new QSlider(Qt::Horizontal, this);
  rSl->setObjectName("vSl");
  rSl->setMinimum(0);
  rSl->setMaximum(1000);
  rSl->setPageStep(125);
  rSl->setValue(0);
  rSl->setTickPosition(QSlider::TicksAbove);

  rLe = new QLineEdit("0.000", this);
  ...
  QLabel *gL1 = new QLabel("G", this);
  QLabel *gL2 = new QLabel("G", this);
  gSl = new QSlider(Qt::Horizontal, this);
  gSl->setObjectName("gSl");
  gSl->setMinimum(0);
  gSl->setMaximum(1000);
  gSl->setPageStep(125);
  gSl->setValue(0);
  gSl->setTickPosition(QSlider::TicksAbove);
  gLe = new QLineEdit("0.000", this);
  ...
  QLabel *bL1 = new QLabel("B", this);
  QLabel *bL2 = new QLabel("B", this);
  bSl = new QSlider(Qt::Horizontal, this);
  bSl->setObjectName("bSl");
  bSl->setMinimum(0);
  bSl->setMaximum(1000);
  bSl->setPageStep(125);
  bSl->setValue(0);
  bSl->setTickPosition(QSlider::TicksAbove);
  bLe = new QLineEdit("0.000", this);
  ...
  closebutton = new QPushButton("Close", status);
  display->addWidget(colourWheel, 10);
  status->addPermanentWidget(closebutton, 0);
...
// SLIDER SIGNALS
// signaled when a value is changed on a slider
...
// signaled to update the values on the sliders after calculation
...
// signaled when user presses return in the line edit boxes
  ...
  if ((hLe->text() == "UNDEF") || (hLe->text() == "undef"))
    ...
    if (ok) {
      ...
      if (selectColour->h() == UNDEFINED)
        ...
        hLe->setText(QString::number(selectColour->h(), 'f', 3));
      status->showMessage("H >= 0 or \"undef\"", 2500);
      return;
    }
  }
...
// ==================== Class: ColourWheel =========================
// -------------------- Construction/Destruction ------------------------
ColourWheel::ColourWheel(QWidget *parent, const char*,
                         QOpenGLWidget*)
...
void ColourWheel::initializeGL() {
  ...
  QColor clear = palette.color(QWidget::backgroundRole());
