...
public slots:
  ...
  void initColour(GLfloat *); // you can set initial colour (eg. to current
                              // colour of what your picking for)
...
public slots:
  ...
  void initColour(
      Colour *); // initialize first select colour and colour to revert to
...
private:
  ...
  int selectObject; // 1 for HS-wheel, 2 for V-scale, 3 for Sample, 4 for
                    // RevertToSample, 0 for none
