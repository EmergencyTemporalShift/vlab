...
template <> constexpr inline auto Preferences::qt_create_metaobjectdata<qt_meta_tag_ZN11PreferencesE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'colorChanged'
        QtMocHelpers::SignalData<void(QColor)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 2 },
        }}),
        // Signal 'backgroundColorChanged'
        QtMocHelpers::SignalData<void(QColor)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 2 },
        }}),
        ...
        // Slot 'Save'
        QtMocHelpers::SlotData<void(QAbstractButton *)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 8, 2 },
        }}),
        // Slot 'Save'
        ...
        // Slot 'set_BorderWidth'
        QtMocHelpers::SlotData<void(int)>(21, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 22 },
        }}),
        // Slot 'getBackgroundColor'
        QtMocHelpers::SlotData<QColor()>(23, 2, QMC::AccessPublic, 0x80000000 | 4),
        // Slot 'getColor'
        QtMocHelpers::SlotData<QColor()>(24, 2, QMC::AccessPublic, 0x80000000 | 4),
        // Slot 'getBorderWidth'
...
void Preferences::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->borderWidthChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->Save((*reinterpret_cast<std::add_pointer_t<QAbstractButton*>>(_a[1]))); break;
        case 5: _t->Save((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        ...
        case 10: _t->pickBackgroundColor(); break;
        case 11: _t->setColor((*reinterpret_cast<std::add_pointer_t<QColor>>(_a[1]))); break;
        case 12: _t->setBackgroundColor((*reinterpret_cast<std::add_pointer_t<QColor>>(_a[1]))); break;
        case 13: _t->resetColor(); break;
        case 14: _t->resetBackgroundColor(); break;
        case 15: _t->set_BorderWidth((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 16: { QColor _r = _t->getBackgroundColor();
            if (_a[0]) *reinterpret_cast<QColor*>(_a[0]) = std::move(_r); }  break;
        case 17: { QColor _r = _t->getColor();
            if (_a[0]) *reinterpret_cast<QColor*>(_a[0]) = std::move(_r); }  break;
        case 18: { int _r = _t->getBorderWidth();
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Preferences::*)()>(_a, &Preferences::configChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Preferences::*)(QColor )>(_a, &Preferences::colorChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Preferences::*)(QColor )>(_a, &Preferences::backgroundColorChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Preferences::*)(int )>(_a, &Preferences::borderWidthChanged, 3))
            return;
    }
}
...
// SIGNAL 1
void Preferences::colorChanged(QColor _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Preferences::backgroundColorChanged(QColor _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void Preferences::borderWidthChanged(int _t1)
{
